...
_Last updated: 2026-06-08 · Running version: **v2026.06.08.007**_
...
- **Branch:** `claude/url-request-GwwHe`. **Origin tip is `98ddcfe`** (confirmed via GitHub API).
  ...
  pushed. **11 commits after `98ddcfe` are LOCAL-only on the box** and need pushing after this `.007` unified-layout release commit.
...
- Local-only commits: `RECOMMENDATIONS.md`; Caddy TLS overlay; trash/audit/perms;
  `v2026.06.04.001` version scheme; `v2026.06.04.002` Trash UI; handoff update; `v2026.06.08.003` rate limiting; `v2026.06.08.004` Microsoft 365 theme; `v2026.06.08.005` full-screen file home; `v2026.06.08.006` file-home cleanup and 365 default; `v2026.06.08.007` unified new layout routing/default home.
- Local-only tags: `v2026.06.04.001`, `v2026.06.04.002`, `v2026.06.08.003`, `v2026.06.08.004`, `v2026.06.08.005`, `v2026.06.08.006`, `v2026.06.08.007`.
...
3. **Next Phase 1 build items** (each its own version bump):
   - `.008` Full-text document search (persist extracted text → Postgres `tsvector` GIN index).
