...
_Last updated: 2026-06-08 · Running version: **v2026.06.08.008**_
...
3. **Next Phase 1 build items** (each its own version bump):
   - `.009` Full-text document search (persist extracted text → Postgres `tsvector` GIN index).
